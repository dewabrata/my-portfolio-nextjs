...
import IconSparkleLoader from "@/app/Components/IconSparkleLoader";
  ...
  const handleJoinRoom = async () => {
    ...
    const response = await fetch("https://api.simli.ai/startE2ESession", {
      ...
      body: JSON.stringify({
        ...
        faceId: "18d80c26-a749-442c-912b-e70bd667562d",
        voiceId: "79f8b5fb-2cc8-479a-80df-29f7a7cf1a3e",
        firstMessage: "Halo apa kabar",
        systemPrompt: "You are hansom man",
      }),
    });

    const data = await response.json();
    console.log("Simli API Response:", data); // Logging respons lengkap
